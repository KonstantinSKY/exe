...
pub fn mount() {
    ...
    exe!("sudo cp {FSTAB_PATH} {FSTAB_PATH}.bak; ls {FSTAB_PATH}.bak");
    ...
    exe!("sudo chown -R {user}:{user} {dir} && sudo chmod -R 700 {dir} && ls -la ~; ls -la {dir}");
}
